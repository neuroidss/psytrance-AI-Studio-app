...
const DEFAULT_PROMPTS = [
  { color: '#00FF00', text: 'Driving Bassline' },
  { color: '#FF00FF', text: 'Acid Lead 303' },
  { color: '#00FFFF', text: 'Galactic Pads' },
  { color: '#FFFF00', text: 'Tribal Percussion' },
  { color: '#FF7F00', text: 'Psychedelic FX Risers' },
  { color: '#7F00FF', text: 'Uplifting Melodies' },
  { color: '#32CD32', text: 'Forest Atmosphere' },
  { color: '#FF1493', text: 'Crisp Hi-Hats' },
  { color: '#1E90FF', text: 'Squishy Synth Zaps' },
  { color: '#FF4500', text: 'Alien Soundscapes' },
  { color: '#ADFF2F', text: 'Gated Synths' },
  { color: '#DA70D6', text: 'Ethereal Voices' },
  { color: '#40E0D0', text: 'Complex Arpeggios' },
  { color: '#FFD700', text: 'Twisted Glitches' },
  { color: '#8A2BE2', text: 'Warped Grooves' },
  { color: '#FF69B4', text: 'Hypnotic Sequences' },
];
